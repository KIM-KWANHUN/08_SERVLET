...
<form action="querystring" method="get">
    ...
    <br>
    <label>생일 : </label><input type="date" name="brith">
    <br>
    <label>성별 : </label>
...
<a href="querystring?name=김관훈&age=30&brith=1995-12-06&gender=M&national=ko&hobbies=movie">
    queryString을 이용한 값 전달..
</a>
<br>
